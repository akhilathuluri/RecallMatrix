  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl relative">
        <div className="mb-10 flex items-center justify-between animate-slide-up">
          <div>
            <Button
              variant="ghost"
              onClick={() => router.push('/')}
              className="mb-4 gap-2 hover:bg-muted rounded-xl smooth-transition"
            >
        ...
        <div className="space-y-6">
          {loading ? (
            ...
            <div className="text-center py-24 animate-fade-in">
              <IconWrapper size="xl" variant="primary" className="mx-auto mb-6 animate-pulse">
              ...
              <Button
                ...
                size="lg"
                className="gap-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl px-8"
              >

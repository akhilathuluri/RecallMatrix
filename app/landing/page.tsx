  ...
  return (
    <div className="min-h-screen relative">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="rounded-xl bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 hover:opacity-90"
            >
              Get Started
            </Button>
          </div>
      ...
      <section className="relative z-10 container mx-auto px-4 py-20 text-center">
        <Badge className="mb-6 rounded-full px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border-blue-500/30">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '100ms' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up" style={{ animationDelay: '200ms' }}>
          <Button
            size="lg"
            onClick={() => router.push('/signup')}
            className="rounded-xl px-8 py-6 text-lg bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 hover:opacity-90 shadow-lg"
          >
            Start Remembering
          ...
          <Button
            ...
            className="rounded-xl px-8 py-6 text-lg border-2"
          >
            Explore Features
          </Button>
        </div>

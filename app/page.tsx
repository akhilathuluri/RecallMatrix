    ...
    <div className="min-h-screen relative">
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl relative">
        <div className={`${(aiAnswer || memories.length > 0) ? '' : 'min-h-[calc(100vh-12rem)] flex flex-col items-center justify-center'}`}>
          <div className="w-full max-w-4xl mx-auto space-y-10 animate-slide-up">
            ...
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-3xl blur-lg opacity-25 group-hover:opacity-40 transition duration-500"></div>
              <div className="relative glass-card rounded-2xl p-2 shadow-2xl">
                <div className="flex items-center gap-3">
                  ...
                  <Input
                    type="text"
                    placeholder={searchMode === 'instant' ? 'Ask anything about your memories...' : 'Start a conversation about your memories...'}
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
                    className="border-0 bg-transparent h-14 text-base focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-muted-foreground/60"
                  />
                  <div className="flex items-center gap-2 pr-2">
                    ...
                    <Button
                      ...
                      size="lg"
                      className="gap-2 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 shadow-lg rounded-xl px-6"
                    >
                      {searching ? (
                        <>
          ...
          {(aiAnswer || memories.length > 0) && (
            <div className="w-full mt-16 space-y-8 animate-fade-in">
              {aiAnswer && (
                <div className="max-w-5xl mx-auto glass-card rounded-3xl p-8 shadow-2xl card-hover border-2">
                  <div className="flex items-start gap-6">
                    <IconWrapper size="lg" variant="primary" className="flex-shrink-0">
